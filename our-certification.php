...
<head>
    ...
    <title>Prixim Global: ISO Certified and a Proud NASSCOM Member</title>
    <meta name="description"
        content="Prixim Global is ISO 9001 and ISO 27001 certified, Shariah compliant, and a proud NASSCOM member, ensuring quality and compliance in Forex solutions.">
...
<body>
    ...
    <main class="main main-body">
        <div class="site-breadcrumb">
            <div class="container">
                <h1 class="breadcrumb-title">Our Certification</h1>
                <ul class="breadcrumb-menu">
                    <li><a href="index.html">Home</a></li>
                    <li><a href="#">Know Us</a></li>
                    <li class="active">Our Certification</li>
                </ul>
                </p>
            </div>
    ...
    <script
        type="application/ld+json">{ "@context": "https://schema.org", "@type": "Organization", "name": "Our Certification", "alternateName": "Our Certification", "url": "https://priximglobal.com/our-certification.html", "logo": "https://priximglobal.com/assets/img/logo/logo.webp", "contactPoint":{ "@type": "ContactPoint", "telephone": "", "contactType": "customer service", "areaServed": "GB", "availableLanguage": "en"}} </script>
