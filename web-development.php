...
<head>
    ...
    <title>Website Development Services for Forex Broker - Prixim Global</title>
    <meta name="description"
        content="Prixim Global offers expert website development services for Forex brokers using HTML, CSS, JavaScript, and more.">
...
<body>
            ...
            <div class="hero-single custom-hero-single" style="background-color: white; padding-top: 50px !important;">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="hero-img vertical-animation"><img src="assets/img/digital/ui-ux-1.webp"
                                    alt="Website Development Services for Forex Broker by Prixim Global"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="hero-single custom-hero-single" style="background-color: white; padding-top: 50px !important;">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="site-heading mb-3">
                                <h2 class="site-title my-3">Types of <span> Web Developemet Services</span></h2>
            ...
            <div class="row align-items-center">
                <div class="col-lg-8 mx-auto">
                    <div class="cta-content">
                        <h2>Looking for Code DevOps for your business?</h2>
                        <p>Contact us now to get your online presence for business growth.</p>
   ...
   <footer class="footer-area">
    ...
    <script
        type="application/ld+json">{ "@context": "https://schema.org", "@type": "Organization", "name": "UI-UX & Media", "alternateName": "UI-UX & Media", "url": "https://priximglobal.com/ui-ux-media.html", "logo": "https://priximglobal.com/assets/img/logo/logo.webp", "contactPoint":{ "@type": "ContactPoint", "telephone": "+917972359229", "contactType": "customer service", "areaServed": "GB", "availableLanguage": "en"}, "sameAs": [ "https://www.facebook.com/priximglobal/", "https://twitter.com/prixim_global", "https://www.instagram.com/prixim_global/", "https://www.linkedin.com/company/prixim-global-private-limited" ]} </script>
