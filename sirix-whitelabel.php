...
<head>
  ...
  <title>Sirix Trading Platform for Forex Brokerages by Prixim Global</title>
  <meta name="description"
    content="Sirix platform by Prixim Global, a user-friendly solution for forex brokerages featuring advanced analysis tools, social trading, and real-time data.">
...
<body>
  ...
  <header class="header">
    <div class="main-navigation">
      <nav class="navbar navbar-expand-lg">
        <div class="container" style="max-width: 1318px"><a class="navbar-brand" href="index.html"><img
              src="assets/img/logo/logo.webp" alt="logo" /></a>
          <div class="mobile-menu-right"><button class="navbar-toggler" type="button" data-bs-toggle="collapse"
              data-bs-target="#main_nav" aria-expanded="false" aria-label="Toggle navigation"><span
                class="navbar-toggler-btn-icon"><i class="far fa-bars"></i></span></button></div>
          <div class="collapse navbar-collapse" id="main_nav">
            <ul class="navbar-nav">
              <li class="nav-item"><a class="nav-link active" href="index.html">Home</a></li>
              <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Know
                  Us</a>
              ...
              <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">FX
                  Platforms</a>
                <ul class="dropdown-menu fade-down">
                  <li><a class="dropdown-item" href="mt5-hosting-whitelabel.html">MT5 Hosting</a></li>
                  <li><a class="dropdown-item" href="match-trader-whitelabel.html">Match Trader</a></li>
                  ...
                  <li><a class="dropdown-item" href="broker-setup-guide.html">Broker Setup Guide
                    </a></li>
                  <li><a class="dropdown-item" href="sirix-whitelabel.html">Sirix (Leverate)</a></li>
                </ul>
              </li>
              <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Prop
                  Platforms</a>
                <ul class="dropdown-menu fade-down">
                  ...
                  <li><a class="dropdown-item" href="turn-key-solution.html">Turnkey Solution
                    </a></li>

                </ul>
              </li>
              <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#"
                  data-bs-toggle="dropdown">OutSource</a>
                <ul class="dropdown-menu fade-down">
                  <li><a class="dropdown-item" href="customer-care-outsourcing-fxbroker.html">Customer Care</a></li>
                  <li><a class="dropdown-item" href="tech-support-outsourcing.html">Tech Support</a></li>
                  <li><a class="dropdown-item" href="live-chat-emails.html">Live Chat & Emails</a></li>
              ...
              <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#"
                  data-bs-toggle="dropdown">Digital</a>
                <ul class="dropdown-menu fade-down">

                  <li><a class="dropdown-item" href="marketing.html">Marketing</a></li>
                  <li><a class="dropdown-item" href="web-development.html">Web Development</a>
            ...
            <div class="row top-hedaer-hidden">
              ...
              <div class="col-md-6 col-lg-3">
                <div class="footer-widget-box about-us">
                  ...
                  <ul class="footer-social" style="margin-top: 15px; justify-content: flex-start;">
                    <li><a href="https://www.facebook.com/priximglobal/" aria-label="facebook" target="_blank"><i
                          class="fab fa-facebook-f" style="
                              color: #ff366b;
                          "></i></a></li>
                    <li><a href="https://twitter.com/prixim_global" aria-label="twitter" target="_blank"><i
                          class="fa-brands fa-x-twitter" style="
                                  color: #ff366b;
                              "></i></a></li>
                    <li><a href="https://www.linkedin.com/company/prixim-global-private-limited/" aria-label="linkedin"
                        target="_blank"><i class="fab fa-linkedin-in" style="
                              color: #ff366b;
                          "></i></a>
                    </li>
                    <li><a href="https://www.instagram.com/prixim_global/" aria-label="instagram" target="_blank"><i
                          class="fab fa-instagram" style="
                              color: #ff366b;
                          "></i></a></li>
                    <li><a href="https://join.skype.com/invite/xraWIPh4p9eP" aria-label="skype" target="_blank"><i
                          class="fab fa-skype" style="
                              color: #ff366b;
                          "></i></a></li>
                  </ul>
                </div>
  ...
  <main class="main">
    <div class="site-breadcrumb">
      <div class="container">
        <h1 class="breadcrumb-title">Sirix</h1>
        <ul class="breadcrumb-menu">
          <li><a href="index.html">Home</a></li>
          <li><a href="#">FX Platform</a></li>
          <li class="active">Sirix</li>
        </ul>
      </div>
    ...
    <div class="hero-section">
      <div class="hero-single custom-hero-single" style="background-color: white; padding-top: 50px !important;">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-6 col-lg-6">
              <div class="hero-content">
                <h1>
                  Sirix Platform for <span style="color: #ff366b;">Forex Brokerages</span> 
                </h1>
                <p class="wow animate__ animate__fadeInUp text-dark animated" data-wow-duration="1s"
                  ...
                  The multi-asset Sirix platform is preferred by successful traders globally and has emerged as a top
                  choice among leading firms. Prixim Global offers this user-friendly, web-based solution featuring
                  advanced analysis tools, social trading, real-time data, and cross-device compatibility, helping
                  brokers attract clients and grow their businesses.
            ...
            <div class="col-md-6 col-lg-6">
              <div class="hero-img vertical-animation">
                <img src="assets\img\sirix\Fx platforms sirix first image.png" alt="Outsource Sirix" loading="lazy">
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      <div class="footer-section" style="border: 1px solid #ccc; border-radius: 5px;">

        <div class="legal-notice">
          <p style="color: #000;">
            <b style="color: #000;">Disclaimer :</b> All the logos, brand names, intellectual property, and trademarks
            belong to their respective owners, and Prixim Global does not hold copyright infringement viewpoints.
            Display
            of them on the website may mean a business/channel partnership or to provide the given services by Prixim
            Global as a third-party provider/vendor.
          </p>
        </div>
      </div>
    </div>
    ...
    <section class="key-benefits" style="padding-top: 80px;">
      <div class="container">
        <div class="row">
          <!-- Image Column (Now on the Left) -->
          <div class="col-lg-6">
            <img src="assets\img\sirix\bulb.png" class="img-fluid" alt="Benefits Image" loading="lazy"
          ...
          <div class="col-lg-6">
            <div class="content">
              <div class="mb-4">
                <h2 class="mb-5 align-items-left">SIRIX Platform Benefits
                </h2>
                <h4 style="margin-bottom: 6px;">1. Trade Anytime, Anywhere:</h4>
                <p>Sirix is a web-based platform that works smoothly and you can access it easily through your web
                  browser on both iOS and Android.</p>
              </div>

              <div class="mb-4">
                <h4 style="margin-bottom: 6px;">2. Stay Informed with Real-Time Data:</h4>
                <p>Make the best trading decisions with real-time data and comprehensive analysis tools at your
                  fingertips.</p>
              </div>

              <div class="mb-4">
                <h4 style="margin-bottom: 6px;">3. Advanced Risk Management:
                </h4>
                <p>Worried about risk? Sirix has got your back with advanced risk management features, including A/B/C
                  Book strategies</p>
              </div>

              <div class="mb-4">
                <h4 style="margin-bottom: 6px;">4. Mobile Trading:
                </h4>
                <p>Enjoy the freedom to trade on the go! Sirix provides user-friendly mobile trading features, so you
                  never miss a chance, no matter where you are.</p>
              </div>
              <div class="mb-4">
                <h4 style="margin-bottom: 6px;">5. Access to Global Markets:
                </h4>
                <p>Dive into a world of opportunities with access to a wide range of global markets, including Forex,
                  cryptocurrencies, and stocks.</p>
          ...
          <div class="col-lg-6">
            <div class="about-left">
              <div class="site-heading mb-3">
                <h2 class="site-title">Why Choose Sirix with <span>Prixim Global</span>
              ...
              <ul class="about-list list-unstyled">
                <li style="font-weight:normal;"><strong>User-friendly:</strong> Intuitive dashboard with one-click
                  execution.

                </li>
                <li style="font-weight:normal;"><strong>Advanced tools:</strong>Powerful indicators and chart analysis.


                </li>
                <li style="font-weight:normal;"><strong>Cross-platform:</strong>Available on Web, Desktop, and Mobile.


                </li>
                <li style="font-weight:normal;"><strong>Seamless experience:</strong> Consistent trading across all
                  devices and styles.
          ...
          <div class="col-lg-6">
            <div class="about-right">
              <div class="about-img vertical-animation"><img
                  src="assets\img\forex\fx platform - Sirix -  Why Choose Sirix with Prixim Global.png"
        ...
        <div class="row align-items-center">
          <div class="col-lg-8 mx-auto">
            <div class="cta-content">
              <h2 style="font-size: 28px;">Unlock the Full Potential of Your Forex Brokerage with Sirix
              </h2>
              <p>Request a free quote today! Simply leave your details, and we'll get in touch with you shortly.
              </p>
                ...
                <div class="contact-form">
                  ...
                  <form id="consult" method="post" action="submit_form.php">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <input type="tel" class="form-control" name="phone_number" placeholder="Enter Your Phone No."
                            required>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <input type="text" class="form-control" name="skype" placeholder="Enter Your Skype ID">
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <div class="custom-select-wrapper">
                            <select id="service-category" name="serviceCategory" class="form-control" required>
                              <option value="" disabled selected>Choose Category</option>
                              <option value="technology">Technology</option>
                              <option value="outsourcing">Outsourcing</option>
                              <option value="digital">Digital</option>
                            </select>
                            <i class="dropdown-icon fa fa-chevron-down"></i> <!-- Dropdown Icon -->
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <div class="custom-select-wrapper">
                            <select id="specific-service" name="specificService" class="form-control" required>
            ...
            <div class="footer-newsletter">
              ...
              <div class="col-md-12">
                <div class="footer-newsletter-content">
                  <img src="assets/img/partner/DUNS img.jpeg" style="border-radius: 50%; justify-content: center;"
                    alt="" class="img1" loading="lazy" />
          ...
          <div class="row footer-widget-wrapper pt-100">
            <div class="col-md-6 col-lg-3">
              <div class="footer-widget-box about-us"><a href="#" class="footer-logo"><img
                    src="assets/img/logo/logo.webp" alt="" style="height: 64px; width: 272px" aria-label="logo"
                    loading="lazy" /></a>
            ...
            <div class="col-md-6 col-lg-3">
              <div class="footer-widget-box list">
                ...
                <ul class="footer-list">
                  <!-- <li><a href="#"><i class="far fa-caret-right"></i></a></li> -->
                  ...
                  <!-- <li><a href="our-brands.html"><i class="far fa-caret-right"></i>Our Brands</a></li>
         <li><a href="#"><i class="far fa-caret-right"></i>Careers</a></li> -->
                </ul>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3">
              <div class="footer-widget-box list">
                ...
                <ul class="footer-list">
                  <li><a href="mt5-hosting-whitelabel.html"><i class="far fa-caret-right"></i>MT5 Hosting</a></li>
                  <li><a href="match-trader-whitelabel.html"><i class="far fa-caret-right"></i>Match Trader</a></li>
                  <li><a href="vertexfx-whitelabel.html"><i class="far fa-caret-right"></i>VertexFX</a></li>
                  <li><a href="wow-trader-whitelabel.html"><i class="far fa-caret-right"></i>Wow Trader</a></li>
                  <li><a href="broker-setup-guide.html"><i class="far fa-caret-right"></i>Broker Setup Guide</a></li>
                  <li><a href="forex-brokerage-calculator.html"><i class="far fa-caret-right"></i>Brokerage Calculator</a></li>
                  <li><a href="sirix-whitelabel.html"><i class="far fa-caret-right"></i>Sirix (Leverate)</a></li>
              ...
              <div class="footer-widget-box list">
                ...
                <ul class="footer-list">
                  ...
                  <li><a href="wow-trader-prop-trading.html"><i class="far fa-caret-right"></i>Wow
                      Trader</a></li>
                  <li><a href="turn-key-solution.html"><i class="far fa-caret-right"></i>Turnkey Solution</a>
                </ul>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3">
              <div class="footer-widget-box list">
                ...
                <ul class="footer-list">
                  <li><a href="customer-care-outsourcing-fxbroker.html"><i class="far fa-caret-right"></i>Customer
                      Care</a>
                  </li>
                  <li><a href="tech-support-outsourcing.html"><i class="far fa-caret-right"></i>Tech Support</a></li>
                  ...
                  <li><a href="server-management.html"><i class="far fa-caret-right"></i>Server Management
                    </a></li>
                  <li>
            ...
            <div class="col-md-6 col-lg-3">
              <div class="footer-widget-box list">
                ...
                <ul class="footer-list">
                  <!-- <li><a href="contents.html"><i class="far fa-caret-right"></i>Contents</a></li> -->
          ...
          <div class="row footer-widget-wrapper pt-20 pb-70">
            ...
            <div class="disclaimer-div">
              <p style="font-size: small;"><b>Disclaimer : </b>Prixim Global is a company registered in India and other
                companies
    ...
    <script
      type="application/ld+json">{ "@context": "https://schema.org", "@type": "Organization", "name": "Sirix", "alternateName": "Sirix", "url": "https://priximglobal.com/Sirix.html", "logo": "https://priximglobal.com/assets/img/logo/logo.webp", "contactPoint":{ "@type": "ContactPoint", "telephone": "+917972359229", "contactType": "customer service", "areaServed": "GB", "availableLanguage": "en"}, "sameAs": [ "https://www.facebook.com/priximglobal/", "https://twitter.com/prixim_global", "https://www.instagram.com/prixim_global/", "https://www.linkedin.com/company/prixim-global-private-limited" ]} </script>
