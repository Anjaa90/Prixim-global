<?php include ('includes/header.php');?>
    ...
    top: -50px;">
                ...
                <!-- <div class="hero-shape"><img class="hero-shape-1" src="assets\img\shape/Prixim Global_landing page 3.webp" alt=""
...
<section>
    <div class="container">
        <h2 class="title text-center">Start Your Broker with Our Company Licensing Services</h2>
        ...
        <style>
            ...
            /* Media Query for Small Mobile Devices (max-width: 576px) */
