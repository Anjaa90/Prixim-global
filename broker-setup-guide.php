...
<head>
    ...
    <title>Forex Brokerage Business Setup Guide. Start with Prixim Global</title>
    <meta name="description"
        content="Launch and grow  Forex brokerage with Prixim Global. We offer platform integration, regulatory support, and expert guidance for success in the Forex market.">
...
<body>
                    ...
                    <div class="footer-widget-box about-us">
                        <ul class="footer-social" style="margin-top: 15px; justify-content: flex-end;">
                            ...
                            <li><a href="https://www.linkedin.com/company/prixim-global-private-limited/"
                                    aria-label="linkedin" target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
    ...
    <main class="main">
        <div class="site-breadcrumb">
            <div class="container">
                <h1 class="breadcrumb-title">Broker Setup Guide
                </h1>
                <ul class="breadcrumb-menu">
                    <li><a href="index.html">Home</a></li>
                    <li><a href="#">FX Platform </a></li>
                    <li class="active">Broker Setup Guide
                    </li>
                </ul>
            </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="site-heading mb-3">
                        <h1 style="text-align: center;">Forex Brokerage Business <span style="color: #ff366b;">Setup
                                Guide</span></h1>
                    </div>
                    <br><br><br><br><br>
                    <div class="col-lg-6">
            ...
            <div class="row align-items-center">
                <div class="col-lg-8 mx-auto">
                    <div class="cta-content">
                        <h2>Ready to start your forex brokerage?
                        </h2>
                        <p>Contact Prixim Global today by filling in the details for expert solutions and support.
                        </p>
                        ...
                        <div class="col-lg-8 align-self-center">
                            <div class="contact-form">
                                <div class="contact-form-header">
                                    <h3>Fill this form for free consultation.</h3>
                                </div>
