...
<body>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="about-right">
                            ...
                            <p class="about-text">
                                <span><a class="Bolder-links" href="https://priximglobal.com/"
                                        style="color: #ff366b">Prixim global</a></span> is proud to offer the Wow Trader
                                platform, designed to revolutionize the trading experience
                                for brokers and their clients in the prop trading brokerage space. With its intuitive
                                design and innovative features, Wow Trader makes trading
                ...
                <div class="row">
                    <div class="col-lg-6 mx-auto">
                        <div class="site-heading text-center">
                            <h4><span class="site-title-tagline">Features </span></h4>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="service-item service-color-1">
                            <div class="service-icon"><i class="fa-thin fa-user-group"></i></div>
                            <div class="service-content">
                                <h3 class="service-title"><a href="#">User-Friendly Interface</a></h3>
                                <p class="service-text">Enjoy a sleek, modern interface that simplifies the trading
                                    process for users of all backgrounds.</p><br>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="service-item service-color-2">
                            <div class="service-icon"><i class="fa-thin fa-chart-user"></i></div>
                            <div class="service-content">
                                <h3 class="service-title"><a href="#">Customizable Dashboard</a></h3>
                                <p class="service-text">Allow clients to tailor their trading environment to fit their
                                    personal preferences and strategies.</p><br>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="service-item service-color-3">
                            <div class="service-icon"><i class="fa-thin fa-bullhorn"></i></div>
                            <div class="service-content">
                                <h3 class="service-title"><a href="#">Real-Time Data and Alerts</a></h3>
                                <p class="service-text">Keep your clients informed with live market data and
                                    customizable alerts to enhance their trading strategies.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="service-item service-color-5">
                            ...
                            <div class="service-content">
                                <h3 class="service-title"><a href="#">Multilingual Support</a></h3>
                                <p class="service-text">Cater to a global audience with multi-language support, ensuring
                                    a seamless trading experience for all users.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="service-item service-color-5">
                            <div class="service-icon"><i class="fa-thin fa-envelope"></i></div>
                            <div class="service-content">
                                <h3 class="service-title"><a href="#">White Label Solutions</a></h3>
                                <p class="service-text">Leverage Prixim Global's WowTrader white label services to
                                    create a unique and branded trading platform for prop trading.
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 text-center mb-30">
                        <div class="process-single process-color-1">
                            ...
                            <h3 style="font-size: 22px">Enhanced Client Engagement</h3>
                            <p>Create a more interactive trading environment with social trading and community features
                                that keep clients engaged in your prop trading brokerage.
                    ...
                    <div class="col-lg-4 col-md-6 text-center mb-30">
                        <div class="process-single process-color-2">
                            ...
                            <h3 style="font-size: 22px">Marketing Support</h3>
                            <p>Benefit from our marketing resources to help you attract and retain clients in a
                    ...
                    <div class="col-lg-4 col-md-6 text-center mb-30">
                        <div class="process-single process-single-last process-color-3">
                            ...
                            <h3 style="font-size: 22px">Fast Onboarding</h3>
                            <p>Enjoy a streamlined onboarding process that gets you and your clients trading quickly and
                                efficiently within your prop trading brokerage.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="cta-area bg pt-60 pb-60">
        <div class="cta-shape">
            <img class="cta-shape-2" src="assets/img/shape/04.png" alt="">
        </div>
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8 mx-auto">
                    <div class="cta-content">
                        <h2>Want To Open A Prop Trading Firm? </h2>
    ...
    <script text="javascript">document.querySelectorAll(".item").forEach(element => {
            if (element.classList.contains("active")) {
                element.classList.remove("active")
            }
            element.addEventListener("click", function (e) {
                if (document.querySelector(".item.active")) { document.querySelector(".item.active").classList.remove("active") }
                if (element.classList.contains("active")) { element.classList.remove("active") } else { element.classList.add("active") }
            })
        }) </script>
    ...
    <script
        type="application/ld+json">{ "@context": "https://schema.org", "@type": "Organization", "name": "Wow Trader", "alternateName": "Wow Trader", "url": "https://priximglobal.com/customer-care.html", "logo": "https://priximglobal.com/assets/img/logo/logo.webp", "contactPoint":{ "@type": "ContactPoint", "telephone": "+917972359229", "contactType": "customer service", "areaServed": "GB", "availableLanguage": "en"}, "sameAs": [ "https://www.facebook.com/priximglobal/", "https://twitter.com/prixim_global", "https://www.instagram.com/prixim_global/", "https://www.linkedin.com/company/prixim-global-private-limited" ]} </script>
