...
switch ($menuactive) {
    ...
    case 'vertexfx-whitelabel.php':
        ...
        case 'xtreme-next.php':
            $title = "Xtreme Next Multi-Asset Trading Platform for Brokers";
            $description = "Xtreme Next by Prixim Global: an advanced multi-asset trading platform, featuring a free CRM, liquidity hub, copy trading, and customizable design.";
            break;
    
        case 'broker-setup-guide.php':
            $title = "Forex Brokerage Business Setup Guide. Start with Prixim Global";
            $description = "Launch and grow Forex brokerage with Prixim Global. We offer platform integration, regulatory support, and expert guidance for success in the Forex market.";
            break;
    
        case 'sirix-whitelabel.php':
            $title = "Sirix Trading Platform for Forex Brokerages by Prixim Global";
            $description = "Sirix platform by Prixim Global, a user-friendly solution for forex brokerages featuring advanced analysis tools, social trading, and real-time data.";
            break;
    
        case 'prop-trading-match-trader.php':
            $title = "Launch Your Prop Trading Brokerage with Match Trader";
            $description = "Start prop trading brokerage with Match Trader by Prixim Global. A user-friendly interface and robust trading capabilities for exceptional client experiences.";
            break;
        ...
        case 'tech-support-outsourcing.php':
            $title = "Comprehensive Tech Support for Smooth Trading Operations";
            $description = "Prixim Global offers complete tech support to ensure your trading platforms run smoothly. Our experts resolve any software or platform-related issues.";
            break;
        ...
        case 'marketing.php':
            $title = "Digital Marketing Services for Forex Brokerages - Prixim Global";
            $description = "Prixim Global's digital marketing solutions for Forex brokerage's online presence, including SEO, PPC, and content marketing. Grow your business today.";
            break;
    
        case 'web-development.php':
            $title = "Website Development Services for Forex Brokers - Prixim Global";
            $description = "Prixim Global offers expert website development services for Forex brokers using HTML, CSS, JavaScript, and more.";
            break;
